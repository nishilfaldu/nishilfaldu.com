...
export const BOOK = {
  ...
  leaves: [
    ...
    },
    {
      slug: "dominoes",
      form: "verse",
      lines: ["क्या-क्या ईंटों को", "किस तरह गिरना पड़ेगा", "तुम्हें मेरे तक पहुँचने के लिए।"],
    },
    {
      slug: "mere-shabd",
      form: "verse",
      lines: ["ये 'मैं' शब्द ही ऐसा…", "दूसरों के लिए", "प्यार कम कर ही देता है।"],
    },
    {
      slug: "shayad-usi-din",
      form: "verse",
    ...
    },
    {
      slug: "life-goes-on",
      form: "verse",
      lines: ["Life goes on,", "people move on,", "but the show must go on."],
    },
    {
      slug: "poets-problem",
      form: "verse",
